...
// ---- Начало кода из первой задачи (функция Calc + вспомогательные) ----
...
// ---- Конец кода из первой задачи ----

// ---- Код веб-сервиса (задача №2) ----
...
func calculateHandler(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// (Можно уточнять условия по вашему вкусу; здесь проверяем лишь часть возможных сообщений)
